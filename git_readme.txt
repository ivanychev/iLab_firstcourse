 ...
 *					-	Changed due to creation repo on Github
 *	
...
5. Пусть вы установили Git. Зайдем на github на веб-страницу с нашим репозиторием

https://github.com/ivanychev/iLab_firstcourse

Обратите внимание, в правом нижнем углу страницы мы видим web-адрес на удаленную копию репозитория, с которым мы будем работать, скопируем его.
...
Обратите внимание на то, что, если вы зайдете на вкладку "коммиты" веб-интерфейса github
https://github.com/ivanychev/iLab_firstcourse/commits/master
...
Пушаем изменения на удаленный сервем. Бэм! Проверяем github, там появился ваш коммит, который я и остальные участники репо смогут прокомментировать или проследить изменения.
...
В Git используются некоторые команды Linux, поэтому неплохо было бы их заботать

ls 	-	показывает все файлы и католи в данной папке
cd 	<название директории> - изменить директорию